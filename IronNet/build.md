...
acl delete <rule_id>
arp add <ip> <mac>
arp flush                           - Clear all ARP entries
arp flood-test [count]              - Fill ARP table with random entries (MAC flood sim)
...
| ironattack | `build/ironattack/ironattack` | Binary | External attack tool (syn-flood, arp-spoof, vlan-hop, rst-inject, ip-spoof, slowloris, frag-attack, icmp-redirect, dns-spoof, dns-spoof-ext, exploit, covert, mac-flood, stealth-scan) |
