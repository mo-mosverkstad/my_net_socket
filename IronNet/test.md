...
Note: The CLI (ironctl), audit logging (ironmon), and application servers (ironapps: echo port 7, DNS port 53, KV port 6379, HTTP port 8080, RPC port 9000) are tested interactively via the daemon, not via CTest. See `DEMO.md` for usage examples.
